...
exports.updateRemoteUserUID = exports.getRemoteUserUIDUpdateDetails = exports.generateContainerEnvs = exports.getExtendImageBuildInfo = exports.extendImage = exports.getSafeId = void 0;
        ...
        await Promise.all([
            ...
            ...featureSet.features
                ...
                const featuresEnv = [
                    ...
                    `_BUILD_ARG_${(0, exports.getSafeId)(f.id)}_TARGETPATH=${path.posix.join('/usr/local/devcontainer-features', (0, containerFeaturesConfiguration_1.getSourceInfoString)(featureSet.sourceInformation), f.id)}`
                ]
                    .join('\n');
...
function getFeatureEnvVariables(f) {
    ...
    const idSafe = (0, exports.getSafeId)(f.id);
    const variables = [];
    if (values) {
        variables.push(...Object.keys(values)
            .map(name => `_BUILD_ARG_${idSafe}_${(0, exports.getSafeId)(name)}="${values[name]}"`));
...
async function updateRemoteUserUID(params, config, imageName, imageDetails, runArgsUser) {
    ...
    if (params.isTTY) {
        ...
        await (0, dockerUtils_1.dockerCLI)(params, ...args);
    }
